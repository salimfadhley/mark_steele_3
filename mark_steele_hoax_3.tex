...
\footnotetext{\dag~Electronic Supplementary Information (ESI) available: [details of any supplementary information available should be included here]. See DOI: 10.1039/cXsm00432x/}
...
The sizes of these nanoparticles comport with 1/4 wavelength of microwave and visible light \cite{SinghGupta2023}. Consequently, they can be used as highly effective transmitters or even reflectors of electromagnetic radiation. This property suggests that these particles will be useful in next-generation radio-frequency modulated medicine \cite{Fernandez2024}.
...
\begin{figure}
    \centering
    \chemfig{*6(1=-(-NH(-[:60](=[::+60]O)-[:-60](=[::-60]O)))--(-OH)=)}
